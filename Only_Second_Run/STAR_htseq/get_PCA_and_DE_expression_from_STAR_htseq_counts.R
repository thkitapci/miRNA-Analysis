...
setwd("C:/Users/thkit_000/Desktop/miRNA-Analysis/Only_Second_Run/STAR_htseq")
library(FactoMineR)
...
input_file="ALL_counts.htseq.csv"
...
write.csv(edgeR_result$table,"miRNA_DE_list_based_on_STAR_htseq_only_second_75bp_run_with_Lynda_Filtering.csv",quote=FALSE)
